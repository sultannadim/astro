    ...
    z.quiz = function(t, e) {
        ...
        o.methods = {
            ...
            setup: function() {
                ...
                }), i += "</div>", 0 === z(a).length && (i += '<div id="' + a.substr(1) + '">', i += '<p id="quiz-results"></p>', i += "</div>"), i += '<div id="quiz-controls">', i += '<p id="quiz-response"></p>', i += '<div id="quiz-buttons">', i += '<a href="#" id="quiz-next-btn" class="btn btn-primary w50">' + d + "</a>", i += '<a href="#" id="quiz-finish-btn" class="btn btn-dark w50">' + l + "</a>", i += '<a href="#" id="quiz-restart-btn" class="btn btn-success w50">' + h + "</a>", i += "</div>", o.$el.append(i += "</div>").addClass("quiz-container quiz-start-state"), z("#quiz-counter").hide(), z(".question-container").hide(), z(c).hide(), z(a).hide(), z("#quiz-controls").hide(), "function" == typeof o.options.setupCallback && o.options.setupCallback()
            },
            start: function() {
